export default function Disclaimer() {
    return (
        <div className="
      relative mx-auto w-full max-w-3xl mt-15
      px-4 sm:px-6
      py-10 sm:py-14
      flex flex-col items-center gap-6 sm:gap-8
      text-center
    ">
            {/* Линки: в колонку на мобиле, в ряд на >=sm */}
            <nav className="
        w-full flex flex-col sm:flex-row sm:flex-wrap
      ...
      ">
            ...
            {/* Текст: без nowrap на мобиле, уже на >=md можно сужать/уплотнять */}
            <section className="
        w-full max-w-2xl
      ...
      ">
            ...
            {/* безопасная зона для iOS, если футер фиксированный: */}
